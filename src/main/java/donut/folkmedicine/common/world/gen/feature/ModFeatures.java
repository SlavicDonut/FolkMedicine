...
public class ModFeatures {
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> LINDEN = register("linden",
            Feature.TREE.withConfiguration((
                    new BaseTreeFeatureConfig.Builder(
                            new SimpleBlockStateProvider(ModBlocks.LINDEN_LOG.get().getDefaultState()),
                            new SimpleBlockStateProvider(ModBlocks.LINDEN_LEAVES.get().getDefaultState()),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> JUNIPER =
            register("juniper", Feature.TREE.withConfiguration((
                    new BaseTreeFeatureConfig.Builder(
                            new SimpleBlockStateProvider(ModBlocks.JUNIPER_LOG.get().getDefaultState()),
                            new SimpleBlockStateProvider(ModBlocks.JUNIPER_LEAVES.get().getDefaultState()),
    ...
    public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> SANDALWOOD =
            register("sandalwood", Feature.TREE.withConfiguration((
                    new BaseTreeFeatureConfig.Builder(
                            new SimpleBlockStateProvider(ModBlocks.SANDALWOOD_LOG.get().getDefaultState()),
                            new SimpleBlockStateProvider(ModBlocks.SANDALWOOD_LEAVES.get().getDefaultState()),
